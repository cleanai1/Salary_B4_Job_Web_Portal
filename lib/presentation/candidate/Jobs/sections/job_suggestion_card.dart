...
class JobSuggestionCards extends StatelessWidget {
  const JobSuggestionCards({super.key});
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        ...
                        //     .visible, // Optionally add this to handle long text
                        maxLines: 2, // Optionally limit the number of lines
                      ),
                    ),
                  ],
                ),
