...
class PatentSection extends StatefulWidget {
  const PatentSection({super.key});

  @override
  State<PatentSection> createState() => _PatentSectionState();
}

class _PatentSectionState extends State<PatentSection> {
