...
class ResearchPublicationSection extends StatefulWidget {
  const ResearchPublicationSection({super.key});

  @override
  State<ResearchPublicationSection> createState() =>
      _ResearchPublicationSectionState();
}

class _ResearchPublicationSectionState
    extends State<ResearchPublicationSection> {
